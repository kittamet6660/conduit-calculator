...
DATA_FILE = "iec_data_v3.json"  # เปลี่ยนชื่อไฟล์เป็น v3 เพื่ออัปเดตฐานข้อมูลใหม่
...
DEFAULT_DATA = {
    ...
    "NYY 1/C (แกนเดี่ยว)": [
        {"sz": 1.0, "od": 8.0},  # แก้ไขให้สมเหตุสมผล (เล็กกว่า 1.5)
        {"sz": 1.5, "od": 8.6}, {"sz": 2.5, "od": 9.0},
